		...
		<View style={styles.container}>
			...
			>
				<View className="flex justify-between items-center mt-10">
					<Image source={noWifi} className="w-20 h-20 opacity-50" />
					<ThemedText type="cardHeader" className="text-[#999]">
...
export default OfflineAppointmentBody;
