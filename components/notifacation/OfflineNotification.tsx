...
const OfflineNotification: React.FC<NotificationProps> = ({
	notifications,
	isOpen,
	toggleDrawer,
	slideAnim,
	...
	const [selectedNotification, setSelectedNotification] =
		useState<Notification | null>(null); // State to hold selected notification
					...
					<Animated.View style={styles.detailsOverlay}>
						...
						<View style={styles.detailsContent}>
							...
							<Text style={styles.notificationDate}>
								{selectedNotification.formattedCreatedAt}
							</Text>
							<Pressable
